...
|--------|--------------------------|--------------------------|----------|------------|--------|
| **Aksu disambiguator (5-seed ensemble)** | **98.3%** [^ensemble] | **98.3%** | Candidate selection | BERTurk (frozen) | 1M |
| Aksu disambiguator (single-seed range) | std 0.11pp [^ensemble] | 97.98–98.28% | Candidate selection | BERTurk (frozen) | 1M |
