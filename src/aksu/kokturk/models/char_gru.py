...
if TYPE_CHECKING:
    from aksu.kokturk.models.morphotactic_mask import MorphotacticMask
...
class CharGRUEncoder(nn.Module):
    ...
    def __init__(
        ...
        if weight_dropout > 0.0:
            from aksu.kokturk.models.variational_dropout import WeightDropout
        ...
        if variational_dropout > 0.0:
            from aksu.kokturk.models.variational_dropout import VariationalDropout
